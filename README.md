...
<details>
    ...
    <!-- wp:shortcode -->
    [yesticket_slides ms-per-slide="30000" color-1="#fff000" color-2="#000fff" welcome-1="erste Zeile" welcome-2="zweite Zeile" welcome-3="drei (zeigt eine vier)" teaser-length="200" text-scale="120%"]
    <!-- /wp:shortcode -->
